...
export const copy = {
  ko: {
    brand: '하나도서관', catalog: '도서', scan: '스캔', borrowing: '대여', settings: '설정',
    ...
    continueGoogle: 'Google로 계속', continueApple: 'Apple로 계속', requestBorrow: '대여 요청', markReturned: '반납 완료',
  },
  en: {
    brand: 'Hana Library', catalog: 'Catalog', scan: 'Scan', borrowing: 'Borrowing', settings: 'Settings',
    ...
    continueGoogle: 'Continue with Google', continueApple: 'Continue with Apple', requestBorrow: 'Request to borrow', markReturned: 'Mark returned',
  },
} as const;
