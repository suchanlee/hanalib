...
export const metadata: Metadata = {
  title: '개인정보 처리방침 · Privacy Policy · Hana Seed Book',
  description: 'How Hana Seed Book handles member and circulation data.',
};
...
export default function PrivacyPage() {
  return (
    <LegalPage
      ...
      intro="This policy explains the information Hana Seed Book handles and the choices available to members. 하나북이 처리하는 정보와 회원의 선택권을 안내합니다."
      sections={sections}
