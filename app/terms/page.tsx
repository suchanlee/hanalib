...
export const metadata: Metadata = {
  title: '이용약관 · Terms of Service · Hana Seed Books',
  description: 'Terms for participating in Hana Seed Books.',
};
...
const sections = [
  {
    ...
    paragraphs: [
      'Hana Seed Books helps members in the United States list, discover, borrow, and return books shared by their community. 하나의 책장은 미국 내 커뮤니티 회원이 책을 등록하고 발견하며 빌리고 반납하도록 돕는 서비스입니다.',
  ...
  },
  {
    ...
    paragraphs: [
      'The service is provided on an “as available” basis and may change or experience interruptions. To the extent permitted by law, Hana Seed Books is not responsible for indirect losses or for disputes, injury, loss, or damage arising from member-to-member exchanges. 서비스는 이용 가능한 상태로 제공되며 변경되거나 중단될 수 있습니다. 법이 허용하는 범위에서 회원 간 교환에서 발생한 분쟁·상해·분실·손상 또는 간접 손실에 책임지지 않습니다.',
...
export default function TermsPage() {
  return (
    <LegalPage
      eyebrow="Terms · 이용약관"
      intro="These terms set expectations for using Hana Seed Books and sharing books with other members. 하나의 책장 이용과 회원 간 도서 공유에 필요한 기본 원칙입니다."
      sections={sections}
