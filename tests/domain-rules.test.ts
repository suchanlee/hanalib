...
test('borrow requests expire exactly 48 hours after creation', () => {
...
test('return checks begin after day seven and repeat weekly', () => {
...
test('only an owner can archive and a borrowed copy cannot be archived', () => {
...
test('borrower or owner can record a return while a loan is active', () => {
...
test('catalog search normalizes Korean and Latin input consistently', () => {
